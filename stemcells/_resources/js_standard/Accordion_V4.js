       ...
       // alert(String.fromCharCode(i));
        try {
            ...
            if (checkclass.indexOf("accordion-form") >= 0) {
                ...
                {
                    document.getElementById(divIndex).className += " accordion-closed";
                }
               ...
               // alert(checkclass);
                if (checkclass.indexOf("accordion-solo") >= 0 || checkclass.indexOf("accordion-scroll-solo") >= 0 || checkclass.indexOf("accordion_right") >= 0) {
